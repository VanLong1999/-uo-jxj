...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>HaVanLong chào ae<Color=/>"):Display()
    wait(.5)
...
local Window = OrionLib:MakeWindow({Name = "HaVanLong", HidePremium = false, IntroText = "HaVanLong⚜️", SaveConfig = true, ConfigFolder = "NightHub"})
...
W:AddLabel("HaVanLong SCRIPT")
W:AddLabel("DiscordHaVanLong")
local Section = W:AddSection({
    Name = "Status"
})
